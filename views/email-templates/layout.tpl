  ...
  <style type="text/css">
    @media screen {
      @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: local('Open Sans Regular'), local('OpenSans-Regular'), url('https://fonts.gstatic.com/s/opensans/v15/mem8YaGs126MiZpBA-UFUZ0d.woff') format('woff'), url('https://fonts.gstatic.com/s/opensans/v15/mem8YaGs126MiZpBA-UFUZ0b.woff2') format('woff2');
      }
      @font-face {
        font-family: 'Open Sans';
        font-style: normal;
        font-weight: 700;
        src: local('Open Sans Bold'), local('OpenSans-Bold'), url('https://fonts.gstatic.com/s/opensans/v15/mem5YaGs126MiZpBA-UN7rgOVuhv.woff') format('woff'), url('https://fonts.gstatic.com/s/opensans/v15/mem5YaGs126MiZpBA-UN7rgOVuhp.woff2') format('woff2');
      }
      @font-face {
        font-family: 'Open Sans';
        font-style: normal;
        font-weight: 800;
        src: local('Open Sans ExtraBold'), local('OpenSans-ExtraBold'), url('https://fonts.gstatic.com/s/opensans/v15/mem5YaGs126MiZpBA-UN8rsOVuhv.woff') format('woff'), url('https://fonts.gstatic.com/s/opensans/v15/mem5YaGs126MiZpBA-UN8rsOVuhp.woff2') format('woff2');
      }
    }
                      ...
                      <tr>
                        <td valign="top">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-p-25-30 pc-xs-p-15-20" style="padding: 29px 40px; background-color: #1d1f23; vertical-align: middle; text-align: center; font-size: 0" bgcolor="#1d1f23" valign="middle">
                                  <!--[if (gte mso 9)|(IE)]><table width="100%" style="text-align: left;" border="0" cellspacing="0" cellpadding="0" role="presentation"><tr><td width="150" valign="middle"><![endif]-->
                                  <div class="pc-sm-mw-100pc" style="display: inline-block; width: 100%; max-width: 150px; vertical-align: middle;">
                                    <table class="pc-sm-w-100pc" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                      <tbody>
                                        <tr>
                                  ...
                                  <!--[if (gte mso 9)|(IE)]></td><td width="220" valign="middle"><![endif]-->
                                  ...
                                  <!--[if (gte mso 9)|(IE)]></td><td width="150" valign="middle"><![endif]-->
                                  <div class="pc-sm-mw-100pc" style="display: inline-block; width: 100%; max-width: 150px; height: 1px; vertical-align: middle; line-height: 1px; font-size: 1px;">&nbsp;</div>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%" role="presentation">
                              <tbody>
                                  <tr>
                                      <td class="pc-sm-p-35-10-15 pc-xs-p-25-0-5" style="vertical-align: top; padding: 40px 20px; background-color: #1d1f23" valign="top" bgcolor="#1d1f23">
                                      <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%" role="presentation">
                                          <tbody>
                                          <tr>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-p-21-10-14 pc-xs-p-5-0" style="padding: 21px 20px 14px; background-color: #16171b" valign="top" bgcolor="#16171b" role="presentation">
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td style="font-size: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" valign="top">
