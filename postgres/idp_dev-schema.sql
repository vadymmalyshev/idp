...
CREATE FUNCTION idp_dev.public.log_last_changes() RETURNS trigger
    LANGUAGE plpgsql
...
CREATE TABLE idp_dev.public.ab_users (
    id integer NOT NULL,
...
ALTER TABLE idp_dev.public.ab_users OWNER TO idp;

--
-- Name: ab_users_id_seq; Type: SEQUENCE; Schema: public; Owner: idp
--

CREATE SEQUENCE idp_dev.public.ab_users_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE idp_dev.public.ab_users_id_seq OWNER TO idp;

--
-- Name: ab_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: idp
--

ALTER SEQUENCE idp_dev.public.ab_users_id_seq OWNED BY idp_dev.public.ab_users.id;
...
CREATE TABLE idp_dev.public.casbin_rules (
    id integer NOT NULL,
    created_at timestamp with time zone,
    updated_at timestamp with time zone,
    deleted_at timestamp with time zone,
...
ALTER TABLE idp_dev.public.casbin_rules OWNER TO idp;

--
-- Name: casbin_rules_id_seq; Type: SEQUENCE; Schema: public; Owner: idp
--

CREATE SEQUENCE idp_dev.public.casbin_rules_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE idp_dev.public.casbin_rules_id_seq OWNER TO idp;

--
-- Name: casbin_rules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: idp
--

ALTER SEQUENCE idp_dev.public.casbin_rules_id_seq OWNED BY idp_dev.public.casbin_rules.id;
...
CREATE TABLE idp_dev.public.last_update (
    id integer NOT NULL,
    tstamp timestamp without time zone DEFAULT now()
);


ALTER TABLE idp_dev.public.last_update OWNER TO idp;

--
-- Name: last_update_id_seq; Type: SEQUENCE; Schema: public; Owner: idp
--

CREATE SEQUENCE idp_dev.public.last_update_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE idp_dev.public.last_update_id_seq OWNER TO idp;

--
-- Name: last_update_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: idp
--

ALTER SEQUENCE idp_dev.public.last_update_id_seq OWNED BY idp_dev.public.last_update.id;
...
CREATE TABLE idp_dev.public.qor_admin_settings (
    id integer NOT NULL,
    created_at timestamp with time zone,
    updated_at timestamp with time zone,
    deleted_at timestamp with time zone,
...
ALTER TABLE idp_dev.public.qor_admin_settings OWNER TO idp;

--
-- Name: qor_admin_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: idp
--

CREATE SEQUENCE idp_dev.public.qor_admin_settings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE idp_dev.public.qor_admin_settings_id_seq OWNER TO idp;

--
-- Name: qor_admin_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: idp
--

ALTER SEQUENCE idp_dev.public.qor_admin_settings_id_seq OWNED BY idp_dev.public.qor_admin_settings.id;
...
ALTER TABLE ONLY idp_dev.public.ab_users ALTER COLUMN id SET DEFAULT nextval('idp_dev.public.ab_users_id_seq'::regclass);
...
ALTER TABLE ONLY idp_dev.public.casbin_rules ALTER COLUMN id SET DEFAULT nextval('idp_dev.public.casbin_rules_id_seq'::regclass);
...
ALTER TABLE ONLY idp_dev.public.last_update ALTER COLUMN id SET DEFAULT nextval('idp_dev.public.last_update_id_seq'::regclass);
...
ALTER TABLE ONLY idp_dev.public.qor_admin_settings ALTER COLUMN id SET DEFAULT nextval('idp_dev.public.qor_admin_settings_id_seq'::regclass);
...
ALTER TABLE ONLY idp_dev.public.ab_users
...
ALTER TABLE ONLY idp_dev.public.casbin_rules
...
ALTER TABLE ONLY idp_dev.public.qor_admin_settings
...
CREATE INDEX idx_ab_users_deleted_at ON idp_dev.public.ab_users USING btree (deleted_at);
...
CREATE INDEX idx_casbin_rules_deleted_at ON idp_dev.public.casbin_rules USING btree (deleted_at);
...
CREATE INDEX idx_qor_admin_settings_deleted_at ON idp_dev.public.qor_admin_settings USING btree (deleted_at);
...
CREATE UNIQUE INDEX uix_ab_users_email ON idp_dev.public.ab_users USING btree (email);
...
CREATE TRIGGER last_change AFTER INSERT OR DELETE OR UPDATE ON idp_dev.public.casbin_rules FOR EACH STATEMENT EXECUTE PROCEDURE idp_dev.public.log_last_changes();
...
INSERT INTO idp_dev.public.ab_users (id, created_at, updated_at, deleted_at, username, email, password, confirm_selector, confirm_verifier, confirmed, attempt_count, last_attempt, locked, recover_selector, recover_verifier, recover_token_expiry, oauth_uid, oauth_provider, oauth_access_token, oauth_refresh_token, oauth_expiry, totp_secret_key, sms_phone_number, sms_seed_phone_number, recovery_codes) VALUES (5, '2019-02-21 15:20:07.975000', '2019-02-21 15:20:10.125000', null, 'vmalyshev', 'vadym.malyshev@gmail.com', '$2a$10$lmWdGp8ZJsFz5wJ9X8fi7uZ95XTC6zcx/trmd/TBuR3znx6.egrVC', null, null, true, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
